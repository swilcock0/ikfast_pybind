...
///
/// ikfast version 0x1000004a generated on 2021-10-08 12:58:09.783841
...
x41=(((x2*x28))+x35);
x42=((((-1.0)*x19*x33))+x36);
x43=(((x20*x32))+(((-1.0)*x19*x2)));
x44=((((-1.0)*x31))+x37);
x45=(((x19*x32))+((x2*x20)));
x46=((((-1.0)*x20*x33))+(((-1.0)*x19*x4)));
x47=(x12*x41);
x48=(x39*x5);
x49=(x43*x9);
x50=(x42*x7);
...
x55=(((x0*x27))+x50);
x56=((((-1.0)*x38))+((x44*x8)));
x57=(((x21*(((((-1.0)*x31))+x37))))+((x14*x26)));
x58=((((-1.0)*x19*x28))+(((-1.0)*x17*x39)));
x59=(((x27*x3))+x52);
x60=((((-1.0)*x17*x40))+(((-1.0)*x20*x28)));
x61=(x12*x55);
x62=(x12*x59);
x63=(((x60*x8))+x49);
eerot[0]=((((-1.0)*x10*(((((1.0)*x13*((x51+((x8*(((((-1.0)*x48))+(((-1.0)*x0*x28))))))))))+(((1.0)*x61))))))+((x11*(((((-1.0)*x14*x45))+(((-1.0)*x21*x53)))))));
eerot[1]=(((x10*((((x34*x45))+((x30*x53))))))+((x11*((((x13*((x51+((x58*x8))))))+x61)))));
eerot[2]=(((x13*x55))+((x12*(((((-1.0)*x21*x45))+(((-1.0)*x14*x58)))))));
eetrans[0]=(((x13*((((x25*x42))+(((0.2535)*x0*x27))))))+((x12*(((((-1.0)*x15*x45))+(((-1.0)*x18*x58))))))+((x24*x27))+((x7*(((((-1.0)*x0*x2*x23))+((x16*x4))))))+((x24*x6)));
eerot[3]=(((x11*((((x34*x43))+((x30*x54))))))+((x10*(((((-1.0)*x22*x63))+(((-1.0)*x62)))))));
eerot[4]=(((x11*((((x13*x63))+x62))))+((x10*(((((-1.0)*x14*x43))+(((-1.0)*x21*x54)))))));
eerot[5]=(((x13*x59))+((x12*(((((-1.0)*x21*x43))+(((-1.0)*x14*x60)))))));
eetrans[1]=(((x13*(((((0.2535)*x27*x3))+((x25*x46))))))+((x7*(((((-1.0)*x24*x4))+(((-1.0)*x16*x33))))))+((x16*x27))+((x12*(((((-1.0)*x15*x43))+(((-1.0)*x18*x60))))))+((x16*x6)));
eerot[6]=(((x11*x57))+((x10*(((((-1.0)*x47))+(((-1.0)*x22*x56)))))));
eerot[7]=(((x10*x57))+((x11*((((x13*x56))+x47)))));
eerot[8]=(((x12*(((((-1.0)*x14*x44))+x38))))+((x13*x41)));
eetrans[2]=((0.787)+((x12*(((((-1.0)*x18*x44))+((x15*x26))))))+((x13*(((((0.2535)*x35))+((x2*x25*x6))))))+((x23*x5))+x23+(((0.4)*x2*x28)));
}
...
new_r01=((-1.0)*r01);
new_r02=r02;
new_px=((((-0.2535)*r02))+px);
new_r10=((-1.0)*r10);
new_r11=((-1.0)*r11);
new_r12=r12;
new_py=((((-0.2535)*r12))+py);
new_r20=((-1.0)*r20);
new_r21=((-1.0)*r21);
new_r22=r22;
new_pz=((-0.787)+pz+(((-0.2535)*r22)));
...
IKFAST_API const char* GetKinematicsHash() { return "<robot:GenericRobot - iiwa7_tool (5d0f75e156339e457815f2cf8b7fafd8)>"; }
